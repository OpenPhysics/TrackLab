...
export const LIGHT_SURFACE_TEXT_FILL = TrackLabColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link TrackLabColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: TrackLabColors.controlSurfaceColorProperty,
  listFill: TrackLabColors.controlSurfaceColorProperty,
  buttonStroke: TrackLabColors.panelBorderColorProperty,
  listStroke: TrackLabColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: TrackLabColors.textColorProperty },
  },
